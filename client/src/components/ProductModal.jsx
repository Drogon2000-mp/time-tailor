...
function ProductModal({ productId, onClose }) {
  ...
  const addToCart = () => {
    ...
    // Ensure description exists for existing cart items too
    if (existingIndex > -1) {
      currentCart[existingIndex].description = product.description || currentCart[existingIndex].description || '';
      currentCart[existingIndex].image = product.images?.[0]?.url || currentCart[existingIndex].image;
      currentCart[existingIndex].name = product.name || currentCart[existingIndex].name;
    }
